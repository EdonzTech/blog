    ...
    <div wire:poll.keep.alive class="max-w-screen-xl w-full mx-auto">
        ...
        <div class=" bg-red-100 border border-gray-200 rounded-lg shadow ">
            ...
            <div class="flex gap-6 px-2 mb-2">
                ...
                <button  wire:click="destory({{ $post->id }})" wire:confirm.prompt="Are you sure you want to delete this blog?\n Type DELETE to confirm|DELETE"  class="bg-red-500 text-xl px-5 py-2 text-white rounded-lg ">Delete</button>
            </div> 
        </div>
    </div>

    <!-- Rendering The Modal Component Here -->
